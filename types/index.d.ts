...
declare class Hexo extends EventEmitter {
    ...
    _bindLocals(): void
    partial(layout: any, locals: any, options: any): any
    execFilterSync(point: any, option: any): any
    ...
    readonly extend: {
        ...
        readonly injector: Hexo.extend.Injector
        /**
...
declare namespace Hexo {
    ...
    namespace extend {
        ...
        interface Injector {
            register(
                name: string,
                fn: string | ((args: string[], content: string | undefined) => string),
                options?: string
            ): void
        }
        namespace Injector {
