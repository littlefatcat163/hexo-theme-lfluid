...
(function() {
  ...
  function localSearchFunc(path, searchSelector, resultSelector) {
    ...
    if ($result.attr('class').indexOf('list-group-item') === -1) {
      $result.html('<div class="m-auto text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Loading...</span></div><br/>Loading...</div>');
    }
  ...
  modal.on('show.bs.modal', function() {
    var path = LNote.root + 'local-search.xml';
